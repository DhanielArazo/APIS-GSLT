	...
	*/
	class Wialon{
		...
		*/
		...
		//****************************** hack gettrips ************************
		public function getTripsUnit($params){
		//	return $params;
  $service_url= 'https://hst-api.wialon.com/wialon/ajax.html';
  $svc='unit/get_trips';
  $parametros='{"itemId":'.$params['itemId'].',	
  		    "msgsSource":"'.$params['msgsSource'].'",
            "timeFrom":'.$params['timeFrom'].',
            "timeTo":'.$params['timeTo'].'}';
  
  $data_string = "svc=".$svc.'&params='.$parametros."&sid=".$params['sid'];

//echo $service_url.$data_string;
